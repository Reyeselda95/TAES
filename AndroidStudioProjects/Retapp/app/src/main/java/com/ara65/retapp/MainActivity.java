...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Esto hace que pueda acceder a los objetos del header
        ...
        mMenuNameTextView.setText(extras.getString("name"));
        //////////////
        //Para la obtención de la imagen
        Picasso.with(getApplicationContext()).load(extras.getString("url")).resize(192,192).centerInside().into(mImageView);//Funciona
